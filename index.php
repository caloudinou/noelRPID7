        ...
        <section>
            <p>venez fêter noël- Vendredi 17 décembre 2014 - à 17h</p>
                <form method="POST" action="">
                    <input type="email" name="email" id="email" placeholder=<?php if(isset($_POST['email'])){ echo '"'.$_POST['email'].'"';}else{echo '"Votre adresse email"';}?> />
                        <input type="nom" name="nom" id="nom" placeholder=<?php if(isset($_POST['nom'])){ echo '"'.$_POST['nom'].'"';}else{echo '"Votre nom"';}?> />
                        <input type="prenom" name="prenom" id="prenom" placeholder=<?php if(isset($_POST['prenom'])){ echo '"'.$_POST['prenom'].'"';}else{echo '"Votre prenom"';}?> />
